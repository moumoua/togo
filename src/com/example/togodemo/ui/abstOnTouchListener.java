...
public abstract class abstOnTouchListener extends FragmentActivity implements OnClickListener,OnTouchListener{
	 ...
	 */
	protected ClassifyFragment classifyFragment;

	/**
	 * 用于展示动态的Fragment，已改成活动
	 */
	protected BusinessFragment businessFragment;

	/**
	 * 用于展示设置的Fragment，已改成购物车
	 */
	protected ShopcarFragment shopcarFragment;
	 ...
	 * 在Tab布局上显示联系人图标的控件
	 */
	protected ImageView contactsImage;
	...
	public void onClick(View v) {
		...
		case R.id.message_layout:
			// 当点击了消息tab时，选中第1个tab
			right.setText(R.string.app_name);
			setTabSelection(0);
			break;
