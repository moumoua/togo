...
public class ClassifyFragment extends Fragment  implements OnClickListener {
	...
	private Button btn_classify_1=null,btn_classify_2=null,btn_classify_3=null,btn_classify_4=null,btn_classify_5=null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		btn_classify_1=(Button) contactsLayout.findViewById(R.id.btn_classify_left_linear1);
		btn_classify_2=(Button) contactsLayout.findViewById(R.id.btn_classify_left_linear2);
		btn_classify_3=(Button) contactsLayout.findViewById(R.id.btn_classify_left_linear3);
		btn_classify_4=(Button) contactsLayout.findViewById(R.id.btn_classify_left_linear4);
		btn_classify_5=(Button) contactsLayout.findViewById(R.id.btn_classify_left_linear5);
...
//			getActivity().startActivity(i);
	...
	private void setTabSelectionClassify(int i) {
		FragmentTransaction tran=fm.beginTransaction();
		switch (i) {
		case 0:
			fg_classify_right1=new ClassifyFragment_right1();
